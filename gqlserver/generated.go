...
func (ec *executionContext) _Blog(ctx context.Context, sel []query.Selection, obj *Blog) graphql.Marshaler {
	fields := graphql.CollectFields(ec.Doc, sel, blogImplementors, ec.Variables)
	...
	for i, field := range fields {
		...
		case "category":
			out.Values[i] = ec._Blog_category(ctx, field, obj)
		default:
...
func (ec *executionContext) _Blog_id(ctx context.Context, field graphql.CollectedField, obj *Blog) graphql.Marshaler {
...
func (ec *executionContext) _Blog_title(ctx context.Context, field graphql.CollectedField, obj *Blog) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Blog"
	rctx.Args = nil
	rctx.Field = field
...
func (ec *executionContext) _Blog_body(ctx context.Context, field graphql.CollectedField, obj *Blog) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Blog"
	rctx.Args = nil
	rctx.Field = field
...
func (ec *executionContext) _Blog_category(ctx context.Context, field graphql.CollectedField, obj *Blog) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "Blog"
	rctx.Args = nil
	rctx.Field = field
...
// nolint: gocyclo, errcheck, gas, goconst
func (ec *executionContext) _Category(ctx context.Context, sel []query.Selection, obj *Category) graphql.Marshaler {
...
func (ec *executionContext) _User(ctx context.Context, sel []query.Selection, obj *User) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "blogs":
			out.Values[i] = ec._User_blogs(ctx, field, obj)
		default:
			panic("unknown field " + strconv.Quote(field.Name))
		}
	}
...
func (ec *executionContext) _User_blogs(ctx context.Context, field graphql.CollectedField, obj *User) graphql.Marshaler {
	rctx := graphql.GetResolverContext(ctx)
	rctx.Object = "User"
	rctx.Args = nil
	rctx.Field = field
	...
	for idx1 := range res {
		arr1 = append(arr1, func() graphql.Marshaler {
			...
			rctx.PushIndex(idx1)
			defer rctx.Pop()
			return ec._Blog(ctx, field.Selections, &res[idx1])
		}())
	}
	return arr1
}
